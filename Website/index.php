  ...
  <div class="container">
        ...
        <div class="container">
            <div class="col-md-4  well wow bounceInLeft animated" style="visibility:visible;animation-name: bounceInLeft;">
                <div>
                     <a href="womens.php" role="button" class="btn btn-default">WOMEN</a>
                </div>
                <div>
                    <img src="images/women.jpg" class="pull-bottom">
                </div>
            </div>
            <div class="col-md-4  well wow bounceInLeft animated" style="visibility:visible;animation-name: bounceInLeft;">
                <div>
                    <a href="mens.php" role="button" class="btn btn-default">MEN</a>
                </div>
                <div>
            ...
            <div class="col-md-4  well wow bounceInLeft animated" style="visibility:visible;animation-name: bounceInLeft;">
                <div>
                    <a href="kids.php" role="button" class="btn btn-default">KIDS</a>
                </div>
                <div>
        ...
        <div class="col-md-6">
                <ul class="footer-nav">
                   <li><a href="index.php">Home</a></li>
                    ...
                    <li><a href="faq.html.php">FAQs</a></li>
                </ul>
